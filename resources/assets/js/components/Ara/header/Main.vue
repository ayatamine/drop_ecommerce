<template>
  <header>
	...
	<nav class="panel-menu mobile-main-menu mm-right">
        <div class="tt-btn-col-close myb"><a >إغلاق</a></div>
		<ul>
			<li>
      ...
      <div class="tt-stuck-nav stuck" style="display: block;">
		<div class="container">
			<div class="tt-header-row ">
                <div class="tt-menu-toggle d-inline-block d-lg-none" >
						<i class="icon-03"></i>
				</div>
                <div class="tt-col-obj tt-obj-logo ml-3 d-none d-lg-block">
                                        <!-- logo -->
                    <a class="tt-logo tt-logo-alignment" href="index.html"><img src="wokiee_ecommerce/images/custom/logo.png" alt="" class="loading" data-was-processed="true"></a>
                                        <!-- /logo -->
                </div>
				<div class="tt-stuck-parent-menu d-none d-lg-block"><div class="tt-desctop-menu">
							<nav>
								<ul>
									...
									<li class="dropdown megamenu tt-submenu">
										<router-link to="/products/كل_المنتجات">المنتجات</router-link>
									</li>
									<!-- <li class="dropdown megamenu tt-submenu">
										<a href="listing-collection.html">المنتجات</a>
									...
									<li class="dropdown megamenu tt-submenu">
										<a href="listing-left-column.html">النساء</a>
									...
									<li class="dropdown megamenu tt-submenu">
										<a href="listing-right-column.html">الرجال</a>
										<div class="dropdown-menu" style="">
											<div class="row">
												<div class="col-sm-9">
													<div class="row tt-col-list">
														<div class="col-sm-4">
															<a href="listing-right-column.html" class="tt-title-submenu">
																TOPS
																<img src="images/custom/header-category-01.jpg" data-src="images/custom/header-category-01.jpg" alt="" class="loaded" data-was-processed="true">
															</a>
															<ul class="tt-megamenu-submenu">
														...
														<div class="col-sm-4">
															<a class="tt-title-submenu" href="listing-right-column.html">
																BOTTOMS
																<img src="images/custom/header-category-02.jpg" data-src="images/custom/header-category-02.jpg" alt="" class="loaded" data-was-processed="true">
															</a>
															<ul class="tt-megamenu-submenu">
																<li><a href="listing-right-column.html">Trousers <span class="tt-badge tt-fatured">Fatured</span></a></li>
																<li><a href="listing-right-column.html">Jeans</a></li>
														...
														<div class="col-sm-4">
															<a class="tt-title-submenu" href="listing-right-column.html">
																ACCESSORIES
																<img src="images/custom/header-category-03.jpg" data-src="images/custom/header-category-03.jpg" alt="" class="loaded" data-was-processed="true">
															</a>
															<ul class="tt-megamenu-submenu">
																<li><a href="listing-right-column.html">Hats</a></li>
																<li><a href="listing-right-column.html">Scarves &amp; Snoods</a></li>
												...
												<div class="col-sm-3">
													<div class="tt-offset-7">
														<a href="listing-left-column.html" class="tt-promo-02">
															<img src="images/custom/header-promo-03.jpg" data-src="images/custom/header-promo-03.jpg" alt="" class="loaded" data-was-processed="true">
				...
				<div class="tt-stuck-parent-search tt-parent-box"><div class="tt-search tt-dropdown-obj">
							...
							<div class="tt-dropdown-menu">
								<div class="container">
									<form>
										<div class="tt-col">
											<input type="text" class="tt-search-input" placeholder="البحث عن منتج">
							...
							<div class="tt-dropdown-menu">
								...
								<div class="tt-dropdown-inner">
									<ul>
									    ...
									    <li><a style="cursor:pointer" v-if="auth" @click.prevent="logout" ><i class="icon-f-77 ml-2"></i>تسجيل الخروج</a></li>
									</ul>
								</div>
							</div>
						</div></div>
				<div class="tt-stuck-parent-multi tt-parent-box"><div class="tt-multi-obj tt-dropdown-obj">
...
$(document).on('mouseenter','.tt-stuck-parent-menu .dropdown a',function(){
    ...
    $('.tt-stuck-parent-menu .dropdown').removeClass('active')
    $(this).parent().addClass('active')
    $('.dropdown-menu').removeClass('hover')
    $(this).siblings('.dropdown-menu').addClass('hover')

})
$(document).on('mouseenter','.tt-stuck-parent-menu .dropdown-menu',function(){
...
$(document).on('mouseenter','.tt-stuck-parent-menu .dropdown-menu .row',function(){
...
$(document).on('click','.tt-dropdown-obj .tt-dropdown-toggle',function(){

   $('.tt-dropdown-obj').removeClass('active')
   $(this).parent().addClass('active removeactive')
})
$(document).on('click','.removeactive',function(){
    $(this).removeClass('active')
    $(this).removeClass('removeactive')
})
$(document).on('click','.tt-btn-close.icon-g-80',function(e){
 e.preventDefault();
 $('.tt-search').removeClass('active')
})
$(document).on('click','.tt-header-row .tt-menu-toggle',function(){
    $('.panel-menu.mobile-main-menu').addClass('mmitemopen')
})
$(document).on('click','.tt-btn-col-close.myb',function(){
    $('.panel-menu.mobile-main-menu').removeClass('mmitemopen')
})
</script>

<style>
.tt-header-row .tt-menu-toggle{flex: 2 1 auto;}
/* @media(max-width:1100px){
    .tt-header-row .tt-menu-toggle{display:inline-block}
    .tt-header-row .tt-stuck-parent-menu{display:none}
} */
.dropdown.active  .dropdown-menu.hover{
 top: 48px;opacity:1;max-height:168px;display : block;overflow:auto
}
.tt-dropdown-obj .tt-dropdown-menu{display: none;}
.tt-dropdown-obj.active .tt-dropdown-menu{display: block !important;}
.tt-search.active .container{display:block !important}
.tt-btn-col-close.myb{ cursor: pointer;
    left: inherit;
    display: block;
    right: 0;
    width: auto;
    box-shadow: 7px -5px 5px 4px #ada8a8;
}.tt-btn-col-close.myb a:before {
   margin-left: 4px !important;
}
.tt-account .tt-dropdown-menu .tt-dropdown-inner {
    padding: 33px 20px 37px 39px !important;
}
</style>